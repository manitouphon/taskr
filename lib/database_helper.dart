...
class DatabaseHelper {
  Future<Database> database() async {
    return openDatabase(
      ...
      onCreate: (db, version) async {
        ...
        await db.execute(
            "CREATE TABLE todo(id INTEGER PRIMARY KEY, taskId INTEGER, name TEXT, isDone INTEGER)");
  ...
  Future<void> updateTaskName(int id, String name) async {
    Database _db = await database();
    await _db.rawUpdate("UPDATE tasks SET name = '$name' WHERE id = '$id'");
  }
